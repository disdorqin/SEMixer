    ...
    def __init__(self,
        ...
        if head_type == 'Flatten':
            ...
            if L % S == 0:
                ...
                N = L // S + 1
            # print(N,dims,self.num_stage)
            # time.sleep(500)
            if seq_len==96:
                self.head = Flatten_Head(individual=False, n_vars=n_vars, nf=N*dims[self.num_stage -2], target_window= pred_len, head_dropout= head_dropout)
            else:
